...
scaled_assembly = scale_and_move_to_point(assembly, Point(-0.375, -0.375, -0.005))
...
def calculate_pick_trajectory(pick_frame, robot):
    ...
    start_configuration = Configuration.from_revolute_values([math.radians(98.36),
                                                              math.radians(-104.76),
                                                              math.radians(-109.78),
                                                              math.radians(-57.24),
                                                              math.radians(91),
...
pick_frame = Frame(point=[0.0, -0.5, 0.03], xaxis=[0, 1, 0], yaxis=[1, 0, 0])
