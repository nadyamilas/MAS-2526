...
class Stick:
    ...
    def from_two_sticks(cls, stick0, stick1, param0, param1, max_iterations=50, length = None):
        ...
        start = stick0.axis.point_at(param0)
        end = stick1.axis.point_at(param1)
    ...
    def geometry(self):
        ...
        circle = Circle(self.radius, frame)
        return Cylinder(self.radius, self.axis.length, frame)
